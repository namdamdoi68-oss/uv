...
use uv_distribution_types::{
    ...
    IndexRoute, IndexRoutes, IndexStatusCodeDecision, IndexStatusCodeStrategy, IndexUrl, Name,
};
...
use uv_pypi_types::{
    HashDigest, HashDigests, PypiSimpleDetail, PypiSimpleIndex, PyxSimpleDetail, PyxSimpleIndex,
    ResolutionMetadata,
};
...
impl RegistryClient {
    ...
    pub async fn proxy_artifact(
        ...
        for (_, file) in metadata.into_iter().flat_map(|version| version.files.all()) {
